...
def default(duration: int):
    ...
    play(tones=tones, duration=duration)
...
if __name__ == "__main__":
    ...
    parser.add_argument('-d', '--duration', dest='duration', type=int, required=True, help='The length of time in hours to stimulate the soundboard')
    ...
    if args.notes == None:
        ...
        play(tones=args.notes, duration=duration)